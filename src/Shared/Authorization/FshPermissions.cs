...
{
    private static FshPermissions _instance;
    private FshPermissions()
    {
            
    }
    private static readonly List<FshPermission> AllPermissions =
    [     
        //tenants
    ...
    public static FshPermissions Instance {
        get
        {
            return _instance ??= new FshPermissions();
        }
    }
