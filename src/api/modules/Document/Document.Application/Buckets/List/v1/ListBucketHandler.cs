...
public sealed class ListAwsBucketHandler(
    ...
    : IRequestHandler<ListBucketCommand, PagedList<BucketResponse>>
{
    public async Task<PagedList<BucketResponse>> Handle(ListBucketCommand request, CancellationToken cancellationToken)
{
