...
{
    /// <summary>
    /// An instance of a <see cref="MudMenu"/>.
    /// </summary>
    /// <seealso cref="MenuReference" />
    public interface IMenuReference
    {
        ...
        bool Dismiss(MenuResult? result);
