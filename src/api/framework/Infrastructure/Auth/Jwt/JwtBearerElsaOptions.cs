...
public class JwtBearerElsaOptions : IConfigureNamedOptions<JwtBearerOptions>
{
    // private readonly JwtOptions _options;
    public JwtBearerElsaOptions(IOptions<JwtOptions> options)
    ...
    public static readonly Action<JwtBearerOptions> ConfigAction = options =>
    {
        ...
        byte[] key = Encoding.UTF8.GetBytes("QsJbczCNysv/5SGh+U7sxedX8C07TPQPBdsnSDKZ/aE="); // get it from appsettings.json
        ...
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            ValidIssuer = JwtAuthConstants.ElsaIssuer,
            ValidateIssuer = true,
            ValidateLifetime = true,
            ValidAudience = JwtAuthConstants.ElsaAudience,
        ...
        options.Events = new JwtBearerEvents
        {
            ...
            OnAuthenticationFailed = context =>
            {
                var logger = context.HttpContext.RequestServices
                    .GetRequiredService<ILogger<JwtBearerElsaOptions>>();
