...
public sealed class ListBucketFolderHandler(
    ...
    ) : IRequestHandler<ListBucketFolderRequest, PagedList<SingleBucketResponse>>
{
   
    public async Task<PagedList<SingleBucketResponse>> Handle(ListBucketFolderRequest request, CancellationToken cancellationToken)
    {
        ...
        var spec = new ListBucketFolderSpecs(request);
